...
public class Walker : PhysicsObject
{
    ...
    [SerializeField] enum EnemyType { Bug, Zombie }; //：敌人会简单地巡逻。飞行者会立刻开始永远追逐你，直到你打败它们。
    [SerializeField] EnemyType enemyType;
   
    public float attentionRange;
    public float changeDirectionEase = 1; //我们应该以多慢的速度改变方向?数字越大，速度越慢!
    [System.NonSerialized] public float direction = 1;
    private Vector2 distanceFromPlayer; //敌人离玩家有多远
    ...
    private float sitStillMultiplier = 1; //如果1，敌人将正常移动。但是，如果它被设置为0，敌人就会完全停止
